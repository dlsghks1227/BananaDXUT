...
GameClearScene::GameClearScene() noexcept
{
	...
	m_UI.AddStatic(static_cast<int>(UI_CONTROL_ID::IDC_HP_TEXT), L"Clear!", 0, 0, 600, 300);
...
void GameClearScene::OnEnterScene()
{
...
void GameClearScene::OnExitScene()
{
}

void GameClearScene::OnUpdate(float fElapsedTime)
{
}

void GameClearScene::OnLateUpdate(float fElapsedTime)
{
}

void GameClearScene::OnRender(float fElapsedTime)
{
}

void GameClearScene::OnUIRender(float fElapsedTime)
{
	m_HUD.OnRender(fElapsedTime);
	m_UI.OnRender(fElapsedTime);
}

void GameClearScene::OnResetDevice()
{
}

void GameClearScene::OnLostDevice()
{
}

void GameClearScene::OnDestroyDevice()
{
}

LRESULT GameClearScene::MsgProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam, bool* pbNoFurtherProcessing, void* pUserContext)
{
